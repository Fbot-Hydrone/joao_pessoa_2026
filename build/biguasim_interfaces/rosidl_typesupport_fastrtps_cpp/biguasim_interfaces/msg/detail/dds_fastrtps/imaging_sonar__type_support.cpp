...
#include "biguasim_interfaces/msg/detail/imaging_sonar__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = biguasim_interfaces::msg::ImagingSonar;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const biguasim_interfaces::msg::ImagingSonar *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<biguasim_interfaces::msg::ImagingSonar *>(
    untyped_ros_message);
...
{
  return &biguasim_interfaces::msg::typesupport_fastrtps_cpp::_ImagingSonar__handle;
}
