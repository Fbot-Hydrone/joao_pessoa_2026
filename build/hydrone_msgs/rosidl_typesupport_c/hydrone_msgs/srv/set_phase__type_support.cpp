...
static const _SetPhase_Request_type_support_symbol_names_t _SetPhase_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hydrone_msgs, srv, SetPhase_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hydrone_msgs, srv, SetPhase_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hydrone_msgs, srv, SetPhase_Request)() {
  return &::hydrone_msgs::srv::rosidl_typesupport_c::SetPhase_Request_message_type_support_handle;
}
...
static const _SetPhase_Response_type_support_symbol_names_t _SetPhase_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hydrone_msgs, srv, SetPhase_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hydrone_msgs, srv, SetPhase_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hydrone_msgs, srv, SetPhase_Response)() {
  return &::hydrone_msgs::srv::rosidl_typesupport_c::SetPhase_Response_message_type_support_handle;
}
...
static const _SetPhase_type_support_symbol_names_t _SetPhase_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hydrone_msgs, srv, SetPhase)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hydrone_msgs, srv, SetPhase)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, hydrone_msgs, srv, SetPhase)() {
  return &::hydrone_msgs::srv::rosidl_typesupport_c::SetPhase_service_type_support_handle;
}
