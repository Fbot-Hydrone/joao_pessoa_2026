...
_colcon_package_sh_COLCON_CURRENT_PREFIX="/home/lh/Documents/joao_pessoa_2026/install/hydrone_nav"
...
# source sh hooks
_colcon_package_sh_source_script "$COLCON_CURRENT_PREFIX/share/hydrone_nav/hook/path.sh"
